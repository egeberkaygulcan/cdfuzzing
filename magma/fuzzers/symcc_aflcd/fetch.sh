...
cp "$FUZZER/newsrc/afl-drift-detect.c" "$FUZZER/afl/afl-drift-detect.c"
cp "$FUZZER/newsrc/afl-drift-detect.h" "$FUZZER/afl/afl-drift-detect.h"
cp "$FUZZER/newsrc/afl-fuzz.c" "$FUZZER/afl/afl-fuzz.c"
cp "$FUZZER/newsrc/Makefile" "$FUZZER/afl/Makefile"
