...
# Copy drift detection files from newsrc
cp "$FUZZER/newsrc/afl-drift-detect.h" "$FUZZER/repo/afl-drift-detect.h"
cp "$FUZZER/newsrc/afl-drift-detect.c" "$FUZZER/repo/afl-drift-detect.c"
